...
class BoundedHistogram:
    ...
    def percentile_of_score(self, score):
        ...
        return summed_count * 100.0 / self.count
...
class UnboundedHistogram:
    ...
    def percentile_of_score(self, score):
        ...
        return num_lower_scores * 100.0 / len(self.history)
...
def test():
    ...
    print(
        "{} get_percentile_of_scores, {} us".format(
            num_trials, float(end - start) / num_trials
        )
    )
